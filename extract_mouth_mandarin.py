...
if __name__ == '__main__':
  ...
  face_predictor_path = "/home/jchou/test/av_hubert/data/misc/shape_predictor_68_face_landmarks.dat"
  mean_face_path = "/home/jchou/test/av_hubert/data/misc/20words_mean_face.npy"

  files = [(join(input_path, f), join(output_path, f)) for f in listdir(input_path) if isfile(join(input_path, f))]

  for origin_clip_path, mouth_roi_path in (sorted(files)):
    print(f'processing {origin_clip_path}')
