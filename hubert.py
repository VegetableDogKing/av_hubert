...
class AVHubertModel(BaseFairseqModel):
    def __init__(
        ...
        **kwargs
        ...
        # print("============ __init__ in AVHubertModel ============")
        super().__init__()
    ...
    def upgrade_state_dict_named(self, state_dict, name):
        # print("============ upgrade_state_dict_named in AVHubertModel ============")
    ...
    def build_model(cls, cfg: AVHubertConfig, task: AVHubertPretrainingTask):
        # print("============ build_model in AVHubertModel ============")
    ...
    def apply_input_mask(self, x, padding_mask, target_list):
        # print("============ apply_input_mask in AVHubertModel ============")
        B, C, T = x.shape[:3]
    ...
    def apply_feature_mask(self, x, padding_mask, target_list):
        # print("============ apply_feature_mask in AVHubertModel ============")
        B, T, C = x.shape
    ...
    def forward_features(self, source: torch.Tensor, modality: str) -> torch.Tensor:
        # print("============ forward_features in AVHubertModel ============")
    ...
    def forward_targets(
        ...
        # print("============ forward_targets in AVHubertModel ============")
    ...
    def forward_padding_mask(
        ...
        # print("============ forward_padding_mask in AVHubertModel ============")
    ...
    def compute_logits(self, feats, emb_mat):
        # print("============ compute_logits in AVHubertModel ============")
    ...
    def forward(
        ...
        # print("============ forward in AVHubertModel ============")
    ...
    def extract_features(
        ...
        # print("============ extract_features in AVHubertModel ============")
        res = self.forward(
            source,
            padding_mask=padding_mask,
            mask=mask,
    ...
    def extract_finetune(self, source, padding_mask=None, mask=False, ret_conv=False, output_layer=None):
        # print("============ extract_finetune in AVHubertModel ============")
        src_audio, src_video = source['audio'], source['video']
        if mask and self.masking_type == 'input':
    ...
    def get_extra_losses(self, net_output):
        # print("============ get_extra_losses in AVHubertModel ============")
        extra_losses = []
        names = []
    ...
    def remove_pretraining_modules(self):
        # print("============ remove_pretraining_modules in AVHubertModel ============")
        self.target_glu = None
    ...
    def compute_nce(self, x, pos, negs):
        # print("============ compute_nce in AVHubertModel ============")
