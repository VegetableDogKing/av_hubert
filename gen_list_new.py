...
test_types = ['babble', 'babycry', '1talker', '2talker', '3talker']
test_noise = [f'{noise_type}_n{-1*d}db' if d<0 else f'{noise_type}_{d}db' for noise_type in test_types for d in range(-7,9,3) ]
